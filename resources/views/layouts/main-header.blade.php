                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-big">
                        ...
                        <li class="nav-item dropdown mr-30">
                            <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                                ...
                                <img src="{{Auth::guard('web')->user()->profile->image_url}}" alt="avatar">
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-header">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <span>{{$user=Auth::guard('web')->user()->email;}}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="dropdown-divider"></div>
                                ...
                                <a class="dropdown-item" href="#"><i class="text-info ti-settings"></i>Settings</a>
                                        ...
                                        <a href="{{ route('logout') }}" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('logout').submit()"><i class="text-danger ti-unlock"></i>Sign Out</a>
