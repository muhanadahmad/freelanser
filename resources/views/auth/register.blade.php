...
<head>
    ...
    <title>Freelanser - Register</title>
                ...
                <div class="col-lg-4 col-md-6 bg-white">
                    <div class="login-fancy pb-40 clearfix">
                        ...
                        <form method="POST" action="{{route('register')}}">
                            ...
                            <div class="section-field mb-20">
                                <label class="mb-10" for="password_confirmation">{{__('Confirm Password')}}</label>
                            ...
                            <button class="button"><span>{{__('Register')}}</span><i class="fa fa-check"></i></button>
                        </form>
                    </div>
                </div>
            </div>
